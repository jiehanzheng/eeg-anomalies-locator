...
print "Loading EEG..."
eeg = eegtools.io.load_edf(open(sys.argv[1]))

def find_anomaly(label1, label2, winsize):
  print "Find anomaly in channel", label1 + '-' + label2 + '...'
  ...
  print "Training models, assuming no more than", CONTAMINATION, "anomaly..."
